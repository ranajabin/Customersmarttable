		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#smarttablecustomernorthwindcustomerfilterproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smarttablecustomernorthwindcustomerfilterproject-display": {
								"semanticObject": "smarttablecustomernorthwindcustomerfilterproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smarttablecustomer.northwindcustomerfilterproject",
									"url": sap.ui.require.toUrl("smarttablecustomer/northwindcustomerfilterproject")
								}
							}
						}
					}
